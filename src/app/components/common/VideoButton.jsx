...
function VideoButton({ text, href, extraClasses, videoextraClassestext }) {
  return (
    <Link
      href={`${href}`}
      className={` ${extraClasses} ${popins.className} bg-[#D8DBFB] max-w-[184px] w-full  py-[10px] rounded-[6px]  gap-[6px] flex justify-center items-center`}
    >
      ...
      <div
        className={` ${videoextraClassestext} max-w-[127px] w-full flex  items-center  text-[16px] font-[600] text-[#000000] leading-[24px]`}
      >
        {text}
      </div>
    </Link>
