    ...
    >
      ...
      <div className="max-w-[790px] w-full flex flex-col  gap-[27px]">
        <div className="w-full flex flex-col gap-[15px]">
          ...
          <div className={`${paraextraClasses}  w-full text-[#5E5D6D]`}>
            {para}
          </div>
        </div>
        {cards &&(
          <AdvertiseCards extraClassesCards={extraClassesCards} maindata={cardsMaindata} singleExtraClass={singleExtraClass}/>
        )
